# Generated by Django 5.2.9 on 2025-12-02 22:25
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('profession', models.CharField(choices=[('handyman', 'Handyman'), ('cleaning', 'Cleaning'), ('moving', 'Moving'), ('homecare', 'Home Care')], max_length=20)),
